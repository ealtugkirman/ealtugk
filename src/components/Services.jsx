...
import services1 from "../assets/mahmut.json";
...
const services = [
  {
    name: "UI/UX Design",
    description:
      "I create user-friendly and visually appealing interfaces that meet your goals. My focus is on user experience and design principles.",
    link: "Learn More",
  },
  {
    name: "Development",
    description:
      "I bring your website to life with efficient, optimized code. I offer full-service web development fast, secure, and search engine friendly.",
    link: "Learn More",
  },
  {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row ">
          ...
          <motion.div
            ...
            <Lottie animationData={services1} loop={true} />
          </motion.div>
          {/* services */}
          <motion.div
